...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if(this.state.touched.firstname && firstname.length < 3)
            ...
            errors.firstname = 'first name should be less thsn 10 characters'

        if(this.state.touched.lastname && lastname.length < 3)
            errors.lastname = 'last name should be more than 3 characters'
        else if(this.state.touched.lastname && lastname.length > 10)
            errors.lastname = 'last name should be less thsn 10 characters'
            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit type= {this.handleSubmit}>
                            <FormGroup row>
